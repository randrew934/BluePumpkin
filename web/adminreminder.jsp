<%-- 
    Document   : adminreminder
    Created on : 12-Jun-2020, 2:12:38 PM
    Author     : Ral
--%>
      ...
      <div class="top_navbar">
       ...
       <div class="side_bar">
         <ul>   
           ...
           <li><a href="adminreminder" class="active"><span class="icon"><i class="fas fa-bell fa-lg" aria-hidden="true"></i></span><span class= "title">Reminder</span></a></li>
