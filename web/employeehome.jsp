<%-- 
    ...
    Created on : 8-Jun-2020, 9:40:22 PM
    Author     : Ral
--%>
      ...
      <div class="top_navbar">
       ...
       <div class="side_bar">
         <ul>
           ...
           <li><a href="SessionVerify" class="active"><span class="icon"><i class="fas fa-home fa-lg" aria-hidden="true"></i></span><span class= "title">Home</span></a></li>
